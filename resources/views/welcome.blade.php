                    ...
                    <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start"
                        ...
                        <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                            <div class="flex items-center justify-between w-full md:w-auto">
                                <a href="#">
                                    <span class="sr-only">Paradeep Parivahan</span>
                                    <img class="w-auto h-8 sm:h-10"
                                        src="{{ asset("/img/theme/asklogistiek-color.png") }}">
                                </a>
                        ...
                        <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                            ...
                            @if (Route::has('login'))
                                @auth
                                    <a href="{{ env('APP_URL') }}/dashboard" class="font-medium text-indigo-600 hover:text-indigo-500">Dashboard</a>
                                @else
                                    <a href="/login" class="font-medium text-gray-500 hover:text-gray-900">Log in</a>
                                @endif
                            @endif
                        </div>
                    </nav>
      ...
      -->
                <div class="absolute inset-x-0 top-0 p-2 transition origin-top-right transform md:hidden">
                    <div class="overflow-hidden bg-white rounded-lg shadow-md ring-1 ring-black ring-opacity-5">
                        <div class="flex items-center justify-between px-5 pt-4">
                            <div>
                                <img class="w-auto h-8" src="{{ asset('/img/theme/asklogistiek-color.png') }}" alt="">
                            </div>
                            <div class="-mr-2">
                                <button type="button"
                                    class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                ...
                <main class="px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block xl:inline">We move earth</span>
                            <span class="block text-indigo-600 xl:inline">the better way</span>
                        </h1>
                        <p
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="object-cover w-full h-56 sm:h-72 md:h-96 lg:w-full lg:h-full"
                src="{{ asset('/img/theme/welcome_cover.jpeg') }}"
                alt="">
        </div>
    </div>
</x-guest-layout>
