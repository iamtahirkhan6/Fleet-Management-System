<div class="lg:grid lg:grid-cols-12 lg:gap-x-5"
    ...
    <aside class="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
        <nav class="space-y-1">
            <a href="#"
               class="text-gray-900 hover:text-gray-900 bg-gray-50 group rounded-md px-3 py-2 flex items-center text-sm font-medium">
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden shadow-lg border-t-4 border-indigo-300">
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Make sure you do not share this in front of any
                            person.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:w-3/6">
                            ...
                            <select wire:model.lazy="input.use_razorpay"
                        ...
                        <div class="col-span-6 sm:w-3/6">
                            ...
                            <input type="text" wire:model.lazy="input.razorpay_key_id"
                                   placeholder="{{ $company->razorpay_key_id }}"
                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            @error('input.razorpay_key_id') <p
                                class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>

                        <div class="col-span-6 sm:w-3/6">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">Razorpay Key Secret</label>
                            <input type="text" wire:model.lazy="input.razorpay_key_secret"
                                   placeholder="{{ $company->razorpay_key_secret }}"
                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    ...
    <!-- Success Modal -->
    <x-modals.basic color="bg-green-100" title="Settings Added"
                    desc="The Razorpay settings has been saved to your account."
    ...
    <x-modals.basic color="bg-red-100" title="Settings Integration Failed"
                    desc="The details could not be saved to your account."
