<x-description-list.main title="Trip Information" desc="All the details regarding the trip is available here.">
  ...
  <x-description-list.row :value="$trip->get_loading_date()"    background="bg-white">Loading Date</x-description-list.row >
  <x-description-list.row :value="$trip->vehicle->number"       background="bg-gray-50">Vehicle Number</x-description-list.row >
