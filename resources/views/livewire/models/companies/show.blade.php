<x-description-list.main title="Company Information" desc="All the details regarding the compmany is available here.">
    ...
    <x-description-list.row :value="$company->total_projects()"     background="bg-gray-50">Projects</x-description-list.row>
    <x-description-list.row :value="$company->total_offices()"      background="bg-white">Offices</x-description-list.row>
    <x-description-list.row :value="$company->total_employees()"    background="bg-gray-50">Employees</x-description-list.row>
