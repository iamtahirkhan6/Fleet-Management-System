...
class PendingRazorpay extends Component
{
    public string $mode = '';
    ...
    public function payUsingRazorpay(
        $payment_id,
        $amount,
        $account_name,
        $account_number,
    ...
    {
        return view('livewire.models.payments.trips.pending-razorpay', [
            'payments' => Payment::wherePaymentMethodId('3')
                ->wherePaymentStatusId('3')
                ->paginate(15),
        ]);
    }
}
