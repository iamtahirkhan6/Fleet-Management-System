...
class EmployeeDesignationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $designation                         = EmployeesDesignation::create([
            "name"               => "Managing Director",
            "emp_desig_class_id" => $employee_designation_classification,
        ]);
        $designation                         = EmployeesDesignation::create([
            "name"               => "Director",
            "emp_desig_class_id" => $employee_designation_classification,
        ...
        $designation                         = EmployeesDesignation::create([
            "name"               => "Executive Assistant To Director",
            "emp_desig_class_id" => $employee_designation_classification,
        ]);
        $designation                         = EmployeesDesignation::create([
            "name"               => "Executive Assistant To Manager",
            "emp_desig_class_id" => $employee_designation_classification,
        ]);
        $designation                         = EmployeesDesignation::create([
        ...
        $designation                         = EmployeesDesignation::create([
            "name"               => "Domestic Cleaner And Helper",
            "emp_desig_class_id" => $employee_designation_classification,
        ]);
        $designation                         = EmployeesDesignation::create([
            "name"               => "Office Cleaner And Helper",
            "emp_desig_class_id" => $employee_designation_classification,
        ]);
        $designation                         = EmployeesDesignation::create([
            "name"               => "Assistant Cook",
