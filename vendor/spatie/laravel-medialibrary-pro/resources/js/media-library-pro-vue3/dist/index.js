    ...
    default: withCtx(({ hasDragObject, isDropTarget, isValid }) => [
      createVNode("button", {
        ...
        class: `media-library-dropzone
                ...
                ${$props.add ? 'media-library-dropzone-add' : 'media-library-dropzone-replace'}
        ...
        ($props.add)
          ? (openBlock(), createBlock("div", _hoisted_2$5, [
              (isValid && hasDragObject)
                ...
                : (openBlock(), createBlock("span", _hoisted_5$2, toDisplayString($options.buildRuleHelpText({ validationRules: $props.validationRules, maxItems: $props.maxItems })), 1))
            ]))
          : createCommentVNode("", true)
      ], 2)
    ]),
