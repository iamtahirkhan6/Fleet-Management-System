...
function render$b(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_media_library_renderless, {
    ...
    _: 1
  }, 8, ["initial-value", "validation-errors", "route-prefix", "validation-rules", "translations", "before-upload", "after-upload", "multiple", "name", "max-items", "max-size-for-preview-in-bytes", "vapor", "vapor-signed-storage-url", "upload-domain", "with-credentials"]))
}
