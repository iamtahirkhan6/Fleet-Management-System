...
export default function MediaLibraryCollection({ name, initialValue, translations, validationRules, validationErrors, routePrefix, sortable, maxItems, maxSizeForPreviewInBytes, vapor, vaporSignedStorageUrl, uploadDomain, withCredentials, setMediaLibrary, propertiesView, fieldsView, beforeUpload, afterUpload, onChange, onIsReadyToSubmitChange, }: Props): JSX.Element;
export {};
